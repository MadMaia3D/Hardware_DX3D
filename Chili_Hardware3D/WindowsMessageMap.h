...
#define REGISTER_MESSAGE(msg){msg,#msg}
	WindowsMessageMap()
		...
		REGISTER_MESSAGE(WM_POINTERDEVICECHANGE),
		REGISTER_MESSAGE(WM_POINTERDEVICEINRANGE),
		REGISTER_MESSAGE(WM_POINTERDEVICEOUTOFRANGE),
		REGISTER_MESSAGE(WM_TOUCH),
		REGISTER_MESSAGE(WM_NCPOINTERUPDATE),
		REGISTER_MESSAGE(WM_NCPOINTERDOWN),
		REGISTER_MESSAGE(WM_NCPOINTERUP),
		REGISTER_MESSAGE(WM_POINTERUPDATE),
		REGISTER_MESSAGE(WM_POINTERDOWN),
		REGISTER_MESSAGE(WM_POINTERUP),
		REGISTER_MESSAGE(WM_POINTERENTER),
		REGISTER_MESSAGE(WM_POINTERLEAVE),
		REGISTER_MESSAGE(WM_POINTERACTIVATE),
		REGISTER_MESSAGE(WM_POINTERCAPTURECHANGED),
		REGISTER_MESSAGE(WM_TOUCHHITTESTING),
		REGISTER_MESSAGE(WM_POINTERWHEEL),
		REGISTER_MESSAGE(WM_POINTERHWHEEL),
		...
		REGISTER_MESSAGE(WM_WTSSESSION_CHANGE),
		REGISTER_MESSAGE(WM_TABLET_FIRST),
		REGISTER_MESSAGE(WM_TABLET_LAST),
		REGISTER_MESSAGE(WM_DPICHANGED),
		REGISTER_MESSAGE(WM_DPICHANGED_BEFOREPARENT),
		REGISTER_MESSAGE(WM_DPICHANGED_AFTERPARENT),
		REGISTER_MESSAGE(WM_GETDPISCALEDSIZE),
		...
		REGISTER_MESSAGE(WM_CLIPBOARDUPDATE),
		REGISTER_MESSAGE(WM_DWMCOMPOSITIONCHANGED),
		REGISTER_MESSAGE(WM_DWMNCRENDERINGCHANGED),
		REGISTER_MESSAGE(WM_DWMCOLORIZATIONCOLORCHANGED),
		REGISTER_MESSAGE(WM_DWMWINDOWMAXIMIZEDCHANGE),
		REGISTER_MESSAGE(WM_DWMSENDICONICTHUMBNAIL),
		REGISTER_MESSAGE(WM_DWMSENDICONICLIVEPREVIEWBITMAP),
		REGISTER_MESSAGE(WM_GETTITLEBARINFOEX),
	...
	{}
	void PrintMessageName(unsigned int message) {
		auto it = map.find(message);

		if (it != map.end()) {
			OutputDebugStringA(it->second.c_str());
		} else {
			OutputDebugStringA("Unregistered Message");
		}
		OutputDebugStringA("\n");
	}
private:
